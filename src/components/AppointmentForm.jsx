...
export default function AppointmentForm() {
  ...
  return (
    <section id="appointment" className="py-20 lg:py-28 px-4 sm:px-8 bg-[#F8FAF9] relative border-t border-[#062B28]/10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#062B28]">
            {t.appointment.title}
          </h2>

          <p className="text-sm sm:text-base text-[#5A6C67] font-arabic mt-3 max-w-2xl">
        ...
        <motion.div
          ...
          className="rounded-3xl bg-white p-6 sm:p-10 border border-[#062B28]/15 shadow-2xl relative overflow-hidden"
        >
          ...
          {isSubmitted ? (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-[#062B28]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs font-bold text-[#062B28] mb-2 flex items-center gap-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-2xl bg-[#F8FAF9] border border-[#062B28]/15 text-sm text-[#1A2321] focus:outline-none focus:border-[#00C4FA] focus:bg-white transition-all"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs font-bold text-[#062B28] mb-2">
              ...
              <div>
                <label className="block text-xs font-bold text-[#062B28] mb-2 flex items-center justify-between">
                  <span className="flex items-center gap-1.5">
                    <FileText className="w-3.5 h-3.5 text-[#D4AF37]" />
                    <span>{t.appointment.uploadLabel}</span>
                  </span>
                  <span className="text-[11px] text-[#5A6C67] font-normal">Max 25MB total</span>
                </label>
                ...
                <motion.div
                  ...
                  className={`cursor-pointer rounded-2xl border-2 border-dashed p-6 text-center transition-all duration-300 ${
                    isDragging
                      ...
                      : 'border-[#062B28]/20 bg-[#F8FAF9] hover:border-[#00C4FA]/50 hover:bg-white'
                  }`}
                >
                  <input
                    type="file"
                  ...
                  <p className="text-xs font-bold text-[#062B28] mb-1">
              ...
              <div className="p-4 rounded-2xl bg-[#062B28]/5 border border-[#062B28]/10 flex items-center gap-3 text-xs text-[#062B28]">
